...
PACKAGE_NAME = 'random-episode'
PACKAGE_DOWNLOAD_URL = 'https://github.com/Nekmo/random-episode/archive/master.zip'  # .tar.gz
URL = 'https://github.com/Nekmo/random-episode'
STATUS_LEVEL = 3  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['random', 'roulette', 'dice', 'episode', 'tv', 'show', 'chapter']  # Palabras clave
...
requirements_path = os.path.join(__dir__, 'requirements.txt'.format(sys.version_info.major))
